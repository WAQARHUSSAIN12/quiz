...
<head>
    ...
    <!-- Toastr style -->
    <link href="{{asset('asset/assets/css/plugins/toastr/toastr.min.css')}}" rel="stylesheet">

    <!-- Gritter -->
    <link href="{{asset('asset/assets/js/plugins/gritter/jquery.gritter.css')}}" rel="stylesheet">

    <link href="{{asset('asset/assets/css/animate.css')}}" rel="stylesheet">
...
<body>
    ...
    <!-- GITTER -->
    <script src="{{asset('asset/js/plugins/gritter/jquery.gritter.min.js')}}"></script>
