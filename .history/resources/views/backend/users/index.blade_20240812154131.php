                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="user-name" name="last_name">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="user-password" name="last_name">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
...
$(document).ready(function() {
    ...
    $('#myForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("admin.add.user") }}', // Replace with your route
            type: 'POST',
            data: formData,
    ...
    // select user status inilialize code 
